...
/**
 * Adapter for the ExcellentEnchants plugin, targeting Minecraft 1.21.5 - 1.21.7 (v1_21_R4).
 *
 * <p>Uses the ExcellentEnchants {@code EnchantUtils} API to read, add, and remove
