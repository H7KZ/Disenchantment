...
public class DisenchantmentRepairGUI implements InventoryHolder {
    ...
    private final GUIItem[] items = ArrayUtils.addAll(
            ...
            new GUIItem(11, Config.Disenchantment.Anvil.Repair.isCostEnabled() ? DefaultGUIElements.enabledRepairCostItem() : DefaultGUIElements.disabledRepairCostItem(), event -> {
                event.setCancelled(true);
            ...
            new GUIItem(13, Config.Disenchantment.Anvil.Repair.isResetEnabled() ? DefaultGUIElements.enabledRepairCostResetItem() : DefaultGUIElements.disabledRepairCostResetItem(), event -> {
                event.setCancelled(true);
            ...
            new GUIItem(14, DefaultGUIElements.repairCostBaseItem((int) Math.round(Config.Disenchantment.Anvil.Repair.getBaseCost()), Math.min((int) Math.round(Config.Disenchantment.Anvil.Repair.getBaseCost()), 64)), event -> {
                event.setCancelled(true);
                ...
                event.setCurrentItem(DefaultGUIElements.repairCostBaseItem((int) Math.round(cost), Math.min((int) Math.round(cost), 64)));
            }),
            new GUIItem(15, DefaultGUIElements.repairCostMultiplierItem(Config.Disenchantment.Anvil.Repair.getCostMultiplier(), Math.min((int) (Config.Disenchantment.Anvil.Repair.getCostMultiplier() * 10), 64)), event -> {
                event.setCancelled(true);
                ...
                event.setCurrentItem(DefaultGUIElements.repairCostMultiplierItem(multiplier, Math.min((int) (multiplier * 10), 64)));
            }),
