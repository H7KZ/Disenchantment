...
public class DisenchantmentSoundGUI implements InventoryHolder {
    ...
    private final GUIItem[] items = ArrayUtils.addAll(
            ...
            new GUIItem(11, Config.Disenchantment.Anvil.Sound.isEnabled() ? DefaultGUIElements.enabledAnvilSoundItem() : DefaultGUIElements.disabledAnvilSoundItem(), event -> {
                event.setCancelled(true);
            ...
            new GUIItem(14, DefaultGUIElements.anvilSoundVolumeItem(Config.Disenchantment.Anvil.Sound.getVolume(), Math.min((int) (Config.Disenchantment.Anvil.Sound.getVolume() * 10), 64)), event -> {
                event.setCancelled(true);
                ...
                event.setCurrentItem(DefaultGUIElements.anvilSoundVolumeItem(volume, Math.min((int) (volume * 10), 64)));
            }),
            new GUIItem(15, DefaultGUIElements.anvilSoundPitchItem(Config.Disenchantment.Anvil.Sound.getPitch(), Math.min((int) (Config.Disenchantment.Anvil.Sound.getPitch() * 10), 64)), event -> {
                event.setCancelled(true);
                ...
                event.setCurrentItem(DefaultGUIElements.anvilSoundPitchItem(pitch, Math.min((int) (pitch * 10), 64)));
            }),
