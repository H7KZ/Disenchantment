...
public class SquarredWrappedEnchantment extends Enchantment {
    ...
    @Override public boolean canEnchantItem(@NotNull ItemStack item) {return false;}
    @Override public @NotNull Component displayName(int level) {return null;}
    ...
    @Override public @NotNull Set<EquipmentSlotGroup> getActiveSlotGroups() {return Set.of();}
    @Override public @NotNull Component description() {return null;}
    @Override public @NotNull RegistryKeySet<ItemType> getSupportedItems() {return null;}
    @Override public @Nullable RegistryKeySet<ItemType> getPrimaryItems() {return null;}
    @Override public int getWeight() {return 0;}
    @Override public @NotNull RegistryKeySet<Enchantment> getExclusiveWith() {return null;}

    @Override // deprecated for suppression not a real issue are not using this function.
    public @NotNull EnchantmentTarget getItemTarget() {return null;}
    @Override // deprecated for suppression not a real issue are not using this function.
    public @NotNull EnchantmentRarity getRarity() {return null;}
    @Override // deprecated for suppression not a real issue are not using this function.
    public float getDamageIncrease(int level, @NotNull EntityCategory entityCategory) {return 0;}
    @Override // deprecated for suppression not a real issue are not using this function.
    public float getDamageIncrease(int level, @NotNull EntityType entityType) {return 0;}
    @Override // deprecated for suppression not a real issue are not using this function.
    public @NotNull String translationKey() {return "";}
    @Override // deprecated for suppression not a real issue are not using this function.
    public @NotNull String getTranslationKey() {return "";}
