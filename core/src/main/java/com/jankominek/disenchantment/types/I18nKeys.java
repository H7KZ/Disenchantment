...
public enum I18nKeys {
    ...
    COMMANDS_ECONOMY_DISENCHANTMENT_TITLE("commands.economy.disenchantment.title"),
    COMMANDS_ECONOMY_DISENCHANTMENT_ENABLED("commands.economy.disenchantment.enabled"),
    COMMANDS_ECONOMY_DISENCHANTMENT_COST("commands.economy.disenchantment.cost"),
    COMMANDS_ECONOMY_DISENCHANTMENT_SHOW_COST("commands.economy.disenchantment.show-cost"),
    COMMANDS_ECONOMY_DISENCHANTMENT_CHARGE_MESSAGE("commands.economy.disenchantment.charge-message"),
    COMMANDS_ECONOMY_DISENCHANTMENT_STATES_ENABLED("commands.economy.disenchantment.states.enabled"),
    COMMANDS_ECONOMY_DISENCHANTMENT_STATES_DISABLED("commands.economy.disenchantment.states.disabled"),

    COMMANDS_ECONOMY_SHATTERMENT_TITLE("commands.economy.shatterment.title"),
    COMMANDS_ECONOMY_SHATTERMENT_ENABLED("commands.economy.shatterment.enabled"),
    COMMANDS_ECONOMY_SHATTERMENT_COST("commands.economy.shatterment.cost"),
    COMMANDS_ECONOMY_SHATTERMENT_SHOW_COST("commands.economy.shatterment.show-cost"),
    COMMANDS_ECONOMY_SHATTERMENT_CHARGE_MESSAGE("commands.economy.shatterment.charge-message"),
    COMMANDS_ECONOMY_SHATTERMENT_STATES_ENABLED("commands.economy.shatterment.states.enabled"),
    COMMANDS_ECONOMY_SHATTERMENT_STATES_DISABLED("commands.economy.shatterment.states.disabled"),

    MESSAGES_ECONOMY_ENABLED_IS_ENABLED("messages.economy-enabled-is-enabled"),
    MESSAGES_ECONOMY_ENABLED_IS_DISABLED("messages.economy-enabled-is-disabled"),
    MESSAGES_ECONOMY_COST_IS_SET("messages.economy-cost-is-set"),
    MESSAGES_ECONOMY_SHOW_COST_IS_ENABLED("messages.economy-show-cost-is-enabled"),
    MESSAGES_ECONOMY_SHOW_COST_IS_DISABLED("messages.economy-show-cost-is-disabled"),
    MESSAGES_ECONOMY_CHARGE_MESSAGE_IS_ENABLED("messages.economy-charge-message-is-enabled"),
    MESSAGES_ECONOMY_CHARGE_MESSAGE_IS_DISABLED("messages.economy-charge-message-is-disabled"),
