...
public enum I18nKeys {
    ...
    MESSAGES_MODE_CURRENT("messages.mode-current"),
    MESSAGES_MODE_SET("messages.mode-set"),
    MESSAGES_MODE_INVALID("messages.mode-invalid"),
    ...
    MESSAGES_MAINTENANCE_ACTIVE("messages.maintenance-active"),
    MESSAGES_MAINTENANCE_IS_ENABLED("messages.maintenance-is-enabled"),
    MESSAGES_MAINTENANCE_IS_DISABLED("messages.maintenance-is-disabled"),
    ...
    GUI_WORLDS_MODE_TITLE("gui.worlds.mode.title"),
    GUI_WORLDS_MODE_LORE("gui.worlds.mode.lore"),
    ...
    GUI_MATERIALS_MODE_TITLE("gui.materials.mode.title"),
    GUI_MATERIALS_MODE_LORE("gui.materials.mode.lore"),
    GUI_RESTRICTION_MODE_ALLOWLIST("gui.restriction-mode.allowlist"),
    GUI_RESTRICTION_MODE_DENYLIST("gui.restriction-mode.denylist"),
