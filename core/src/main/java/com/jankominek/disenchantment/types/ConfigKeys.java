...
public enum ConfigKeys {
    ...
    DISENCHANTMENT_ANVIL_BYPASS_TOO_EXPENSIVE("disenchantment.anvil.bypass-too-expensive"),
    ...
    SHATTERMENT_ANVIL_BYPASS_TOO_EXPENSIVE("shatterment.anvil.bypass-too-expensive"),
