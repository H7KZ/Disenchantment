...
/**
 * Migration step 11: copies all existing keys (except the migration version marker)
 * into the new configuration template, introducing the {@code disenchantment.cost-multiplier.luckperms}
 * and {@code disenchantment.cooldown.*} keys (all defaulting to disabled/0, preserving prior behavior).
 */
public class Migration11 implements IConfigMigration {
    /**
     * {@inheritDoc}
     */
