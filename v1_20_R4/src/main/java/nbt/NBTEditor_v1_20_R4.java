 ...
 * @version 7.19.1
 */
public final class NBTEditor_v1_20_R4 {
    ...
    static {
        ...
        reflectionTargets.addAll(Arrays.asList(
                new ReflectionTarget.v1_8().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_9().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_11().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_12().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_13().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_15().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_16().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_17().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_18_R1().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_18_R2().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
                new ReflectionTarget.v1_19_R1().setClassFetcher(NBTEditor_v1_20_R4::getNMSClass),
    ...
    public enum MinecraftVersion {
         ...
         *
         * @param v the Bukkit package version string (e.g. "v1_20_R4")
