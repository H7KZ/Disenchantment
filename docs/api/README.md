...
<dependency>
    ...
    <scope>system</scope>
    <systemPath>${project.basedir}/libs/Disenchantment-6.5.12.jar</systemPath>
</dependency>
```

Replace `6.5.12` with the version you are targeting and adjust `systemPath` to wherever you placed the JAR.

### Gradle

```groovy
dependencies {
    compileOnly files('libs/Disenchantment-6.5.12.jar')
}
```
