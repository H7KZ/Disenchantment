...
- `/disenchantment diagnostic ['all']` - Show diagnostic information about the plugin. Use 'all' to show all
  information.
...
- `/disenchantment disenchant:enchantments [enchantment] ['enable', 'keep', 'delete', 'disable']` - Change configuration
  of disabled enchantments.
...
- `/disenchantment disenchant:repair reset ['enable', 'disable']` - Enable/disable the reset of repair cost to 0 after
  disenchantment.
...
- `/disenchantment shatter:enchantments [enchantment] ['enable', 'keep', 'delete', 'disable']` - Change configuration of
...
- `/disenchantment shatter:repair reset ['enable', 'disable']` - Enable/disable the reset of repair cost to 0 after
  shatterment.
